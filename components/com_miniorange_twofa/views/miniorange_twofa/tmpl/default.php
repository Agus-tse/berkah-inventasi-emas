...
<html>
        <head>
	    	<link rel="stylesheet" type="text/css" href="<?php echo JURI::base() . 'components/com_miniorange_twofa/media/css/mo_tfa_inline.css';?>">
	    	<link rel="stylesheet" type="text/css" href="<?php echo JURI::base() . 'administrator/components/com_miniorange_twofa/assets/css/mo_tfa_phone.css';?>">
			<link rel="stylesheet" type="text/css" href="<?php echo JURI::base() . 'administrator/components/com_miniorange_twofa/assets/css/miniorange_boot.css';?>">
		...
		<?php
				...
				if(isset($fields)&&!empty($fields))
				{
					...
					$primarybtn = strtok($CustomButtonSaved,'!');
					?>
					<?php
				}
				?>
                        ...
                        if($method=='OOE')
                        {
                            ...
                            {                    
                                ...
                                if ($response->status == 'SUCCESS'){
                                    ...
                                    $msg = JText::_('COM_MINIORANGE_OTP_SUCCESS_MSG') . $email . JText::_('COM_MINIORANGE_MSG_ENTER_OTP');
...
function invokeOOE($info, $msg = '', $msgType = ''){
    ...
    ?>
    <div class="mo_boot_container-fluid mo_boot_text-center mo_tfa_container">
            ...
            <div class="mo_boot_col-sm-4 mo_boot_offset-sm-4">
                <div class="mo_boot_row mo_tfa_main mo_tfa_custom">
                    <div class="mo_boot_col-sm-12 mo_tfa_title">
                        <center><?php echo JText::_('COM_MINIORANGE_INVOKEOOE');?></center>
                    </div>
                    ...
                    <div class="mo_boot_col-sm-12">
                        <form name="f" method="post" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.validateEmail'); ?>">
                            <div class="mo_boot_row">
                                <div class="mo_boot_col-lg-4 mo_boot_col-sm-12">
                                    <label><strong><?php echo JText::_('COM_MINIORANGE_EMAIL');?></strong></label>
                                </div>
                                <div class="mo_boot_col-lg-8 mo_boot_col-sm-12">
                                    <input type="email" class="input mo_boot_form-control" name="miniorange_registered_email" value="<?php echo $email; ?>" style="cursor:pointer;" placeholder="<?php echo JText::_('COM_MINIORANGE_EMAIL');?>" required readonly/>
                                </div>
                            </div>
                            <div class="mo_boot_row mo_boot_mt-3">
                                <div class="mo_boot_col-sm-12">
									<input type="button" onclick="previousStep()" name="Start_registration" class="mo_boot_btn mo_boot_btn-reset" value="<?php echo JText::_('COM_MINIORANGE_BACK');?>"  />
                                    <input type="submit"  name="Start_registration" class="mo_boot_btn mo_boot_btn-primary mo_btn_custom" value="<?php echo JText::_('COM_MINIORANGE_VAL_NEXT');?>" />
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <form name="fback" method="post" id="stepValidateBackupCodeBack" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.backValidateBackup'); ?>">
    </form>
    <form name="fback" method="post" id="stepThreeBack" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.gotoPreviousStep'); ?>">
    </form>
    <script type="text/javascript">
...
function validateEmail($msg, $msgType)
{
    ...
    <div class="mo_boot_container-fluid mo_boot_text-center mo_tfa_container">
        <div class="mo_boot_row">
            <div class="mo_boot_col-sm-4 mo_boot_offset-sm-4">
                <div class="mo_boot_row mo_tfa_main mo_tfa_custom">
                    <div class="mo_boot_col-sm-12 mo_tfa_title">
                        <center><?php echo JText::_('COM_MINIORANGE_EMAIL_VALIDATE');?></center>
                    </div>
                    <div class="mo_boot_col-sm-12">
                        <?php
                        if(!empty($msg)){
                            ?>
                            <div class="mo_boot_p-1 mo_boot_alert-secondary mo_tfa_text"><center><?php echo $msg;?></center></div>
                            <?php
                        }
                        ?>
                    </div>
                    <div class="mo_boot_col-sm-12 mo_boot_mt-2">
                        <form name="f" method="post" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.validateOOE'); ?>">
                            <div class="mo_boot_row">
                                <div class="mo_boot_col-sm-10 mo_boot_text-left">
                                    <label class="mo_tfa_text"><?php echo JText::_('COM_MINIORANGE_PASSCODE1');?></label>
                                </div>
							</div>
							<div class="mo_boot_row">
                                <div class="mo_boot_col-sm-8 ">
                                    <input type="text" class="input mo_boot_form-control mo_tfa_text" name="Passcode" value="" placeholder="<?php echo JText::_('COM_MINIORANGE_ENTER_PASSCODE');?>" autofocus required />
                                </div>
                            </div>
                            <div class="mo_boot_row mo_boot_mt-3">
                                <div class="mo_boot_col-sm-12 mo_boot_text-right">
                                    <input type="button" onclick="previousStep()" name="Start_registration" class="mo_boot_btn mo_boot_btn-secondary mo_tfa_text" value="<?php echo JText::_('COM_MINIORANGE_BACK');?>" formnovalidate  />
                                    <input type="submit"  name="Start_registration" class="mo_boot_btn mo_boot_btn-primary mo_btn_custom mo_tfa_text" value="<?php echo JText::_('COM_MINIORANGE_VERIFY_NEXT');?>"  />
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <form name="fback" method="post" id="navigateToBack" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.gotoPreviousStep'); ?>">
    </form>
	<form name="fback" method="post" id="navigateToBack1" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.handleBackOfInline'); ?>">
    </form>
    <script type="text/javascript">
        function previousStep(){
    ...
    <div class="mo_boot_container-fluid mo_boot_text-center mo_tfa_container">
        <div class="mo_boot_row">
            <div class="mo_boot_col-sm-5 mo_boot_offset-sm-3">
                <div class="mo_boot_row mo_tfa_main mo_tfa_custom">
                    <div class="mo_boot_col-sm-12 mo_tfa_title">
                        <?php echo JText::_('COM_MINIORANGE_BACKUP_DOWNLOAD');?><hr>
                    </div>
					
                    <div class="mo_boot_col-sm-11 mo_boot_alert-secondary mo_boot_mx-4 mo_tfa_text"><?php echo JText::_('COM_MINIORANGE_BACKUP_DESC');?></div>

                    <div class="mo_boot_col-sm-12">
                        <form name="f" method="post" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.stepFiveSubmitForBackupCode'); ?>">
                            <div class="mo_boot_row mo_boot_mt-3">
                                <div class="mo_boot_col-sm-12">
                                    <div class="mo_boot_row mo_boot_mt-3">
                                    ...
                                    <div class="mo_boot_row mo_boot_mt-3">
                                        <div class="mo_boot_col-sm-12 ">
											...
											<a class="mo_boot_btn mo_boot_btn-primary mo_btn_custom mo_tfa_text" style="color:white;"
                                               href="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&download_backup_code=downloadbkpcode'); ?>" >
											   <?php echo JText::_('COM_MINIORANGE_DOWNLOAD_CODES');?></a>
                                            <button type="submit" name="Start_registration"  class="mo_boot_btn mo_boot_btn-secondary mo_tfa_text"><?php echo JText::_('COM_MINIORANGE_FINISH');?></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
function validateBackupCode($msg, $msgType)
{
    if($msgType != 'mo2f-message-error'){
        $msg = JText::_('COM_MINIORANGE_MSG');
    }
    ?>
    <div class="mo_boot_container-fluid mo_boot_text-center mo_tfa_container">
        <div class="mo_boot_row">
            <div class="mo_boot_col-sm-4 mo_boot_offset-sm-4">
                <div class="mo_boot_row  mo_tfa_main mo_tfa_custom">
                    <div class="mo_boot_col-sm-12 mo_tfa_title" style="border-bottom:0px">
                        <span><center><?php echo JText::_('COM_MINIORANGE_VALIDATE_CODES');?></center></span>
                    </div>
                  
                    <div class="mo_boot_col-sm-12  mo_boot_mt-3">
                        <form name="f" method="post" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.validateBackupCodes'); ?>">
                            <div class="mo_boot_row mo_boot_mb-3">
								<div class="mo_boot_col-sm-12">
									<?php
									if(!empty($msg)){
										?>
										<div class="mo_boot_p-1 mo_tfa_text <?php echo ($msgType=='mo2f-message-status') ? 'mo_boot_alert-secondary' : 'mo_boot_alert-danger'; ?>" ><center><?php echo $msg;?></center></div>
										<?php
									}
									?>
								</div>
							...
							<div class="mo_boot_row">
                                <div class="mo_boot_col-sm-12">
                                    <input type="text" class="input mo_boot_form-control mo_tfa_text"  name="backup_code_value" placeholder="<?php echo JText::_('COM_MINIORANGE_ENTER_CODE');?>" required/>
                                </div>
                                <div class="mo_boot_col-sm-12 mo_boot_mt-3">
                                    <input type="submit"  name="validate_backup_code" class="mo_boot_btn mo_boot_btn-primary mo_btn_custom mo_tfa_text"  value="<?php echo JText::_('COM_MINIORANGE_VALIDATE');?>"  />
                                    <input type="button" onclick="previousStep()" name="step_Back" class="mo_boot_btn mo_boot_btn-secondary mo_tfa_text"  value="<?php echo JText::_('COM_MINIORANGE_CANCEL');?>" formnovalidate  />
                                </div>
                            </div>
                        </form>
                    </div>
	...
	<form name="fback" method="post" id="stepTwoBack" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.handleBackOfInline'); ?>">
    </form>
    <script type="text/javascript">
        function previousStep(){
...
function showStep1($info,$msg='',$msgType=''){
	...
	<div class="mo_boot_container-fluid mo_boot_text-center mo_tfa_container">
		<div class="mo_boot_row">
			<div class="mo_boot_col-sm-4 mo_boot_offset-sm-4">
				<div class="mo_boot_row mo_tfa_main mo_tfa_custom">
					<div class="mo_boot_col-sm-12 mo_tfa_title">
						<center><?php echo JText::_('COM_MINIORANGE_STEP1');?></center>
					</div>
					<div class="mo_boot_col-sm-12">
						<?php 
							if(!empty($msg)){
					...
					<div class="mo_boot_col-sm-12">
						<p>
						<?php echo JText::_('COM_MINIORANGE_STEP1_DESC');?>
						</p>
					</div> 
					<div class="mo_boot_col-sm-12">
						<form name="f" method="post" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.testing'); ?>"> 
							<div class="mo_boot_row">
								<div class="mo_boot_col-lg-4 mo_boot_col-sm-12">
									<label><strong><?php echo JText::_('COM_MINIORANGE_EMAIL');?>:</strong></label>
								</div>
								<div class="mo_boot_col-lg-8 mo_boot_col-sm-12">
									...
									<input id="edit_email" type="email" class="input mo_boot_form-control" name="miniorange_registered_email" value="<?php echo $email; ?>" style="cursor:pointer;" placeholder="<?php echo JText::_('COM_MINIORANGE_EMAIL');?>" readonly/>
								</div>
							</div>
							<div class="mo_boot_row mo_boot_mt-3">
								<div class="mo_boot_col-sm-12">
									<input type="submit"  name="Start_registration" class="mo_boot_btn mo_boot_btn-primary mo_btn_custom" value="<?php echo JText::_('COM_MINIORANGE_REGISTER');?>"  />
									<input type="button" onclick="previousStep()" name="cancel_registration" class="mo_boot_btn mo_boot_btn-danger" value="<?php echo JText::_('COM_MINIORANGE_CANCEL');?>"  />
                                    <?php if (is_null($row) && isset($settings['skip_tfa_for_users']) && $settings['skip_tfa_for_users'] == 1 ) {
                                        ?>
                                        <input type="button" onclick="skip_tfa_inline_registration()" name="mo_skip_tfa" class="mo_boot_btn mo_boot_btn-primary mo_btn_custom" id="SkipTfaButton" value="<?php echo JText::_('COM_MINIORANGE_SKIP2FA');?>"  />
										<?php
                                    }
                                    ?>
                                </div>
	...
	<form name="fback" method="post" id="stepOneBack" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.handleBackOfInline'); ?>">
	</form>
	<script type="text/javascript">
		function previousStep(){
    ...
    <form name="skip_tfa_button" method="post" id="skipTfa" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.skipTwoFactor'); ?>">
    </form>
    <script type="text/javascript">
...
function showStep2($msg='',$msgType=''){
	...
	<div class="mo_boot_container-fluid mo_boot_text-center mo_tfa_container">
		<div class="mo_boot_row">
			<div class="mo_boot_col-sm-4 mo_boot_offset-sm-4">
				<div class="mo_boot_row mo_tfa_main mo_tfa_custom">
					<div class="mo_boot_col-sm-12 mo_tfa_title">
						<center><?php echo JText::_('COM_MINIORANGE_STEP2');?></center>
						</div>
					<div class="mo_boot_col-sm-12">
						<?php 
							if(!empty($msg)){
					...
					<div class="mo_boot_col-sm-12">
					<form name="f" method="post" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.pageTwoSubmit'); ?>">
							<div class="mo_boot_row">
								<div class="mo_boot_col-lg-5 mo_boot_col-sm-12">
									<label><?php echo JText::_('COM_MINIORANGE_PASSCODE1');?></label>
								</div>
								<div class="mo_boot_col-lg-7 mo_boot_col-sm-12">
									<input type="text" class="input mo_boot_form-control" name="Passcode" value="" placeholder="<?php echo JText::_('COM_MINIORANGE_ENTER_PASSCODE');?>" autofocus required />		  
								</div>
							</div>
							<div class="mo_boot_row mo_boot_mt-3">
								<div class="mo_boot_col-sm-12">
									<input type="button" onclick="previousStep()" name="Start_registration" class="mo_boot_btn mo_tfa_text mo_boot_btn-secondary" value="<?php echo JText::_('COM_MINIORANGE_BACK');?>" formnovalidate  />
									<input type="submit"  name="Start_registration" class="mo_boot_btn mo_boot_btn-primary mo_tfa_text mo_btn_custom" value="<?php echo JText::_('COM_MINIORANGE_VERIFY_NEXT');?>"  />
								</div>
							</div>
						</form>
					</div>
	...
	<form name="fback" method="post" id="stepTwoBack" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.handleBackOfInlineTwo'); ?>">			
	</form>
	<script type="text/javascript">
		function previousStep(){
			document.getElementById('stepTwoBack').submit();
...
function showStep3($msg='',$msgType=''){
	...
	<div class="mo_boot_container-fluid mo_boot_text-center mo_tfa_container">
		<div class="mo_boot_row">
			<div class="mo_boot_col-sm-4 mo_boot_offset-sm-4" >
				<div class="mo_boot_row mo_tfa_main mo_tfa_custom" style="min-height:212px; width:85%">
					<div class="mo_boot_col-sm-12 mo_tfa_title">
						<center><?php echo JText::_('COM_MINIORANGE_STEP3');?></center>
					</div>
					<div class="mo_boot_col-sm-12">
						<?php 
							if(!empty($msg)){
							?>
							<div class="mo_boot_p-1 mo_tfa_text <?php echo($msgType=='mo2f-message-error') ? 'mo_boot_alert-danger':' mo_boot_alert-info' ?>"><center><?php echo $msg;?></center></div>
							<?php
							}
							else
							{
								?>
									<div class="mo_boot_p-1 mo_tfa_text mo_boot_alert-info"><center>Select a method to setup as your Second Factor Authentication </center></div>
								<?php
							}
					...
					<div class="mo_boot_col-sm-12">
						<form name="f" method="post" id="2fa_methods" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.thirdStepSubmit'); ?>">
							<div class="mo_boot_row mo_boot_text-left">
								<div class="mo_boot_col-sm-11 mo_boot_mt-3 mo_boot_ml-2">
									<span class="mo_tfa_text"><strong><?php echo JText::_('COM_MINIORANGE_METHOD');?></strong></span>
								</div>
								<div class='mo_boot_col-sm-8 mo_boot_m-2'>
									<select class ="mo_boot_form-control mo_tfa_text" name="miniorangetfa_method" id="miniorangetfa_method">
									<?php
										foreach ($active2FAs as $key=>$value)
											if($value['active'])
												echo "<option class='mo_tfa_text' value=".$key." />".$value['name']."</option>";
	                                ?>
									</select>
								</div>
							</div>
							<div class="mo_boot_row mo_boot_mt-3">
								<div class="mo_boot_col-sm-12 mo_boot_text-right">
									<input type ="button" onclick="backToStep1()" class="mo_boot_btn mo_boot_btn-secondary mo_tfa_text" style="margin-right: 3px;" value="<?php echo JText::_('COM_MINIORANGE_BACK');?>" />
					  				<input type="submit" name="Start_registration" class="mo_boot_btn mo_boot_btn-primary mo_tfa_text mo_btn_custom" style="margin-right: 3px;" value="<?php echo JText::_('COM_MINIORANGE_SELECT_METHOD');?>"  />
									<?php if ( is_null($row) && isset($settings['skip_tfa_for_users']) && $settings['skip_tfa_for_users'] == 1  ) {
                                    ?> 
                                    <button type="button" onclick="skip_tfa_inline_registration()" name="mo_skip_tfa" class="mo_boot_btn mo_boot_btn-primary mo_tfa_text mo_btn_custom" id="SkipTfaButton" ><?php echo JText::_('COM_MINIORANGE_SKIP2FA');?> </button>
										<?php
                                    }?>
								</div>
							</div>
	...
	<form name="fback" method="post" id="mo_skip_email" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.handleBackOfInline'); ?>"></form>
    <script type="text/javascript">
...
function showStep4($msg='',$msgType=''){
	...
	<div class="mo_boot_container-fluid mo_boot_text-center mo_tfa_container">
		<div class="mo_boot_row">
			<div class="mo_boot_col-sm-4 mo_boot_offset-sm-4">
				<div class="mo_boot_row mo_tfa_main mo_tfa_custom">
					<div class="mo_boot_col-sm-12 mo_tfa_title">
						<center><?php echo JText::_('COM_MINIORANGE_STEP4');?></center>
					</div>
					<div class="mo_boot_col-sm-12">
						<?php
						if(!empty($msg))
						...
						{
							?>
							<div class="mo_boot_p-1 mo_boot_alert-info mo_tfa_text"><center><?php echo ($tfa_method=='OOS')? JText::_('COM_MINIORANGE_TFA_PHONE') : JText::_('COM_MINIORANGE_TFA_MSG_SMS_EMAIL'); ?></center></div>
							<?php
						}
						?>
						</div> 
					<div class="mo_boot_col-sm-12">
                        ...
                        <form name="f" method="post" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.pageFourAndHAlf'); ?>"> 
							<div class="mo_boot_row mo_boot_mt-3 mo_boot_text-left">
								<div class="mo_boot_col-sm-12">
									<label class="mo_tfa_text" style="font-weight:500"><?php echo JText::_('COM_MINIORANGE_PHONE');?>:</label>
								</div>
							
							
								<div class="mo_boot_col-sm-8">
									<input type="tel" required class="input mo_tfa_query_phone mo_boot_form-control mo_tfa_text" id="mo_tfa_query_phone" name="phone" pattern="[\+]\d{11,14}|[\+]\d{1,4}([\s]{0,1})(\d{0}|\d{9,10})" value="<?php echo $phone;?>" placeholder="<?php echo JText::_('COM_MINIORANGE_ENTER_PHONE');?>" autofocus />
								</div>
							
							
								<div class="mo_boot_col-sm-4">
									<input type="submit"  name="sendOtpBtn" class="mo_boot_btn mo_btn_custom mo_tfa_text" style="background-color:#43b38a;border-color:#43b38a" id="send_otp_btn" value="<?php echo JText::_('COM_MINIORANGE_SEND_OTP');?>"  />
                                </div>
							</div>
							<div class="mo_boot_row mo_boot_mt-3 mo_boot_text-left">
								<div class="mo_boot_col-sm-12">
									<label class="mo_tfa_text" style="font-weight:500"><?php echo JText::_('COM_MINIORANGE_PASSCODE1');?></label>
								</div>
								<div class="mo_boot_col-sm-8">
									<input type="text" id="moPass" class="input mo_boot_form-control mo_tfa_text"  name="Passcode1" value="" placeholder="<?php echo JText::_('COM_MINIORANGE_ENTER_PASSCODE');?>" autofocus />
								</div>
							</div>
							<div class="mo_boot_row mo_boot_mt-3">
								<div class="mo_boot_col-sm-12">
									<input type="button" onclick="backToStep2()" name="Start_registration" class="mo_boot_btn mo_boot_btn-secondary mo_tfa_text" value=" <?php echo JText::_('COM_MINIORANGE_BACK');?>"  />
									<input type="button" onclick="submitNextForm()" name="Start_registration" class="mo_boot_btn mo_boot_btn-primary mo_btn_custom mo_tfa_text" value="<?php echo JText::_('COM_MINIORANGE_VERIFY_NEXT');?>"  />
								</div>
							</div>
						</form>
						<form name="f" method="post" id="moStepFourNextForm" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.pageFourValidatePasscode'); ?>">
					  		<input type="hidden" id="moHiddenPasscode" name="Passcode" value="" placeholder="<?php echo JText::_('COM_MINIORANGE_ENTER_PASSCODE');?>" autofocus />
					  	</form>
					</div>
				</div>
			</div>
	...
	<form name="fback" method="post" id="stepTwoBack" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.handleBackOfInlineFour'); ?>">			
	</form>
	<form name="fback" method="post" id="stepTwoBack1" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.handleBackOfInline'); ?>">			
	</form>
...
function showStep5(){
    ...
    $invokeOOE = $session->get('ooe_for_change_2fa');
        $step = JText::_('COM_MINIORANGE_STEP ');
	...
	<div class="mo_boot_container-fluid mo_boot_text-center mo_tfa_container">
		<div class="mo_boot_row">
			<div class="mo_boot_col-sm-6 mo_boot_offset-sm-3">
				<div class="mo_boot_row mo_tfa_main mo_tfa_custom">
					<div class="mo_boot_col-sm-12 mo_tfa_title">
						<center><?php echo JText::_('COM_MINIORANGE_STEP_BACKUP');?> </center>
					</div>
					<div class="mo_boot_col-sm-12">
						<form name="f" method="post" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.stepFiveSubmit'); ?>">
							<div class="mo_boot_row mo_boot_mt-3 mo_boot_text-left">
								<div class="mo_boot_col-sm-11 mo_boot_alert-secondary mo_boot_mx-4 mo_tfa_text">
								<?php echo JText::_('COM_MINIORANGE_BACKUP_QUESTIONS');?>
								</div>
							</div>
							<div class="mo_boot_row mo_boot_mt-3">
								<div class="mo_boot_col-sm-12">
									<div class="mo_boot_row mo_boot_mt-3">
										<div class="mo_boot_col-sm-8 mo_tfa_text">
											<strong><?php echo JText::_('COM_MINIORANGE_QUESTION');?></strong>
										</div>
										<div class="mo_boot_col-sm-4 mo_tfa_text">
											<strong><?php echo JText::_('COM_MINIORANGE_ANSWER');?></strong>
										</div>
									</div>
									<div class="mo_boot_row mo_boot_mt-3">
										<div class="mo_boot_col-sm-8">
											<select class="mo_boot_form-control mo_tfa_text" name="mo_tfa_ques_1">
												<?php echo $options['0']; ?>
											</select>
										</div>
										<div class="mo_boot_col-sm-4">
											<input class="mo_tfa_input mo_boot_form-control mo_tfa_text" type="text" name="mo_tfa_ans_1" placeholder="<?php echo JText::_("COM_MINIORANGE_VAL_ANSWER")?>" required />
										</div>
									</div>
									<div class="mo_boot_row mo_boot_mt-3">
										<div class="mo_boot_col-sm-8">
											<select class="mo_tfa_input_kba mo_boot_form-control mo_tfa_text" name="mo_tfa_ques_2">
												<?php echo $options['1']; ?>
											</select>
										</div>
										<div class="mo_boot_col-sm-4">
											<input class="mo_tfa_input mo_boot_form-control mo_tfa_text" type="text" name="mo_tfa_ans_2" placeholder="<?php echo JText::_("COM_MINIORANGE_VAL_ANSWER")?>" required />
										</div>
									</div>
									<div class="mo_boot_row mo_boot_mt-3">
										<div class="mo_boot_col-sm-8">
											<input class="mo_tfa_input_kba mo_boot_form-control mo_tfa_text" placeholder="<?php echo JText::_('COM_MINIORANGE_SECURITY_QUESTION');?>" name="mo_tfa_ques_3" required />
										</div>
										<div class="mo_boot_col-sm-4">
											<input class="mo_tfa_input mo_boot_form-control mo_tfa_text" type="text" name="mo_tfa_ans_3" placeholder="<?php echo JText::_("COM_MINIORANGE_VAL_ANSWER")?>" required/>
										</div>
									</div>
									<div class="mo_boot_row mo_boot_mt-3">
										<div class="mo_boot_col-sm-12">
	...
	<form name="fback" method="post" id="stepTwoBack" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.handleBackOfInlineFive'); ?>">
	</form>
	<script type="text/javascript">
...
{   
	...
	$info = $session->get('motfa');
	$current_user = isset($info['inline']['whoStarted']) ? $info['inline']['whoStarted'] : '';
	$googleInfo=$session->get('googleInfo');
	$email = $current_user->email;
    ...
    <div class="mo_boot_container-fluid mo_boot_text-center mo_tfa_container">
		<div class="mo_boot_row">
			<div class="mo_boot_col-sm-4 mo_boot_offset-sm-4">
				<div class="mo_boot_row mo_tfa_main mo_tfa_custom">
					<div class="mo_boot_col-sm-12 mo_tfa_title">
						<center><?php echo JText::_('COM_MINIORANGE_CONFIGURE');?></center>
					</div>
					...
					<div class="mo_boot_col-sm-12">
						...
						if(!empty($msg)){
							?>
							<div class="mo_boot_col-sm-12">
								<div class="mo_boot_p-1 mo_tfa_text <?php echo($msgType=='mo2f-message-status') ? ' mo_boot_alert-info':' mo_boot_alert-danger' ?>"><center><?php echo $msg ?></center></div>
							</div>
							<?php
						}
					  	?>
					</div>
					<div class="mo_boot_col-sm-12 mo_boot_text-left mo_boot_my-2">
						<form name="f" method="post" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.pageFourValidatePasscode'); ?>">
                            <div class="mo_boot_row">
                                <div class="mo_boot_col-sm-12">
                                    <label class="mo_tfa_text"><strong>Hardware Token One time passcode :</strong></label>
                                </div>
                                <div class="mo_boot_col-sm-12">
                                    <input type="text" class="input mo_boot_form-control mo_tfa_text" style="width:80%" name="mo_auth_token_textfield" value="" placeholder="Your passcode" autofocus required />
                                </div>
                            </div>
                            <div class="mo_boot_row mo_boot_mt-3">
                                <div class="mo_boot_col-sm-12" style="text-align:right">
                                    <input type="button" onclick="backToStep2()" name="Backto_registration" class="mo_boot_btn mo_boot_btn-secondary mo_tfa_text" value="<?php echo JText::_('COM_MINIORANGE_BACK');?>" formnovalidate  />
                                    <input type="submit"  name="auth_token_submit" class="mo_boot_btn mo_boot_btn-primary mo_btn_custom" value="<?php echo JText::_('COM_MINIORANGE_VERIFY');?>"  />
                                </div>
                            </div>
                        </form>
					</div>
			...
			<div class="mo_boot_col-sm-12">
				...
				if(!empty($msg)){
					?>
					<div class="mo_boot_col-sm-12">
							<div class="mo_boot_p-1 mo_tfa_text <?php echo($msgType=='mo2f-message-status') ? ' mo_boot_alert-info':' mo_boot_alert-danger' ?>"><center><?php echo ($msgType=='mo2f-message-error') ? "The passcode you entered is incorrect" : $msg ;?></center></div>
						</div>
					<?php
				}
				?>
			...
			<div class="mo_boot_col-sm-12">
				<div class="mo_boot_row ">
					<div class="mo_boot_col-sm-12 mo_boot_text-left mo_boot_my-2">
						<details>
							<summary><span class="mo_tfa_text"><?php echo JText::_('COM_MINIORANGE_CONFIG_STEP1');?><strong> <?php echo $appName[$name];?> <?php echo JText::_('COM_MINIORANGE_AUTHENTICATOR_APP');?></strong></span></summary>

							<table width="100%;" id="mo2f_inline_table">
							<tr id="mo2f_inline_table">
								<td style="padding:10px;">
									<h3 class="mo_h3 mo_tfa_text" id="user_phone_id"><?php echo JText::_('COM_MINIORANGE_IPHONE');?></h3>
									<hr>
									<ol class="mo_tfa_text">
										<li><?php echo JText::_('COM_MINIORANGE_IPHONE_STEP1');?></li>
										<li><?php echo JText::_('COM_MINIORANGE_SEARCH');?> <?php echo $appName[$name] ?> <?php echo JText::_('COM_MINIORANGE_AUTHENTICATOR');?></li>
										<li><?php echo JText::_('COM_MINIORANGE_INSTALL');?></li>
									</ol>
									
								</td>
								<td style="padding:10px;">
									<h3 class="mo_h3 mo_tfa_text" id="user_phone_id"><?php echo JText::_('COM_MINIORANGE_ANDROID');?></h3>
									<hr>
									<ol class="mo_tfa_text">
										<li><?php echo JText::_('COM_MINIORANGE_ANDROID_STEP1');?></li>
										<li><?php echo JText::_('COM_MINIORANGE_SEARCH');?> <?php echo $appName[$name];?> <?php echo JText::_('COM_MINIORANGE_AUTHENTICATOR');?></li>
										<li><?php echo JText::_('COM_MINIORANGE_INSTALL');?></li>
									</ol>
					...
					<div class="mo_boot_col-sm-12 mo_boot_mt-3 mo_boot_text-left">
						<details open>
							<summary><span class="mo_tfa_text"><?php echo JText::_('COM_MINIORANGE_CONFIG_STEP2');?> <strong><?php echo $appName[$name] ;?> <?php echo JText::_('COM_MINIORANGE_AUTHENTICATOR_APP');?></strong> </span></summary>
							
							</details>
					</div>
					<div class="mo_boot_col-sm-12">
						<div class="mo_boot_row">
							<div class="mo_boot_col-sm-4 mo_boot_m-2">
								<?php echo '<img src="data:image/jpg;base64,' .$response['QR']. '" />'; ?>
							</div>
							<div class="mo_boot_col-sm-6 mo_boot_mt-4">
								<div class="googleauth-secret  mo_tfa_text" >
									<p><?php echo JText::_('COM_MINIORANGE_CONFIG_SECRET');?></p>
									<span class="mo_boot_alert-secondary" style="padding:2px"><strong><?php echo $response['code'];?></strong></span>
									<p>(<?php echo JText::_('COM_MINIORANGE_SPACES');?>)</p>
								</div>
							</div>
						</div>			
					</div> 
					<div class="mo_boot_col-sm-12 mo_boot_mt-3 mo_boot_text-left">
						<details open>
							<summary>
								<span class="mo_tfa_text"><?php echo JText::_('COM_MINIORANGE_CONFIG_STEP3');?> <strong><?php echo $appName[$name];?> <?php echo JText::_('COM_MINIORANGE_AUTHENTICATOR_APP');?></span>
							</summary>
						
						</details>
						<form name="f" id="step_two" method="post" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.pageFourValidatePasscode'); ?>">
							<div class="mo_boot_row mo_boot_text-sm-left">
								
								<div class="mo_boot_col-sm-12 mo_boot_m-3">
									<input type="text" class="mo_tfa_input mo_boot_form-control mo_tfa_text" name="Passcode" style="width:70%" placeholder="<?php echo JText::_('COM_MINIORANGE_ENTER_PASSCODE');?>" required="true" autofocus="true" />
								</div>
								<div class="mo_boot_col-sm-12 mo_boot_mt-3" style="text-align:right">
									<input type="button" onclick="backToStep2()" class="mo_boot_btn mo_boot_btn-secondary mo_tfa_text" style="margin-right: 3px;" name="google_passcode_submit" value="<?php echo JText::_('COM_MINIORANGE_BACK');?>" />
				                    <input type="submit" class="mo_boot_btn mo_boot_btn-primary mo_tfa_text mo_btn_custom" name="google_passcode_submit" value="<?php echo JText::_('COM_MINIORANGE_VERIFY');?>"/>
								</div>
							</div>
						</form>
					</div>
...
function moTfaChallangeForm($msg='',$msgType=''){ 
	...
	$isSystemEnabled = JPluginHelper::isEnabled('system','miniorangepasswordlesslogin');
	if($isSystemEnabled)
	{
  ...
  <div class="mo_boot_container-fluid mo_boot_text-center mo_tfa_container">
		<div class="mo_boot_row">
			<div class="mo_boot_col-sm-4 mo_boot_offset-sm-4">
				<div class="mo_boot_row mo_tfa_main mo_tfa_custom">
					<div class="mo_boot_col-sm-12 mo_tfa_title" style="border-bottom:0px">
						<center> <span><?php echo JText::_('COM_MINIORANGE_AUTHENTICATE');?></span></center>
					</div>
					<div class="mo_boot_col-sm-12 mo_boot_mt-3">
						<form name="f" method="post" id="morba_loginform" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.validateTfaChallange'); ?>"> 
								<div class="mo_boot_row mo_boot_mb-3">
										...
										<?php 
											if(!empty($msg))
											{
												if(!empty($challangeInfo->authType) && $msgType=='mo2f-message-status'){
													...
													{
														?>
														<div class="mo_boot_p-1 mo_boot_alert-secondary mo_tfa_text"><span><?php echo JText::_('COM_MINIORANGE_AUTHENTICATE_PASSCODE');?> <strong><?php echo $appName[$name];?> <?php echo JText::_('COM_MINIORANGE_AUTHENTICATOR_APP');?> </span></div>
														<?php
													}
												...
												{
													?>
														<div class="mo_boot_p-1 mo_boot_alert-danger mo_tfa_text"><span ><center><?php echo $msg; ?></center></span></div>
													<?php
												}
												else
												{
								...
								<div class="mo_boot_row">
									...
									<div class="mo_boot_col-sm-11 mo_boot_mx-4">
										<input type="text" class="input mo_boot_form-control mo_tfa_text" name="passcode" placeholder="<?php echo JText::_('COM_MINIORANGE_PASSCODE');?>" required/>
									</div>
								</div>
								...
								<div class="mo_boot_row">
								    ...
								    if($remember_device  && $enable_password_less_login!='1' && $enable_tfa_password_less_login!=1 ){ ?>
											...
											<input class=" mo_tfa_login_options" type="checkbox" name="remember_device" />&nbsp;<span style="font-weight:500;color:dimgrey;font-family: ui-sans-serif;"><?php echo JText::_('COM_MINIORANGE_REMEMBER_DEVICE');?></span><br><br>
								...
								<div class="mo_boot_row">
									<div class="mo_boot_col-sm-5 mo_boot_mt-2 mo_boot_ml-4 ">
										...
										if(!empty($backup_method) && $backup_method!= 'none'){?>
											...
											<a class="mo_boot_forgot_phn" style="color:#377eff;font-family: ui-sans-serif;float:left;" href="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&task=miniorange_inline.handleForgotForm'); ?>" ><?php echo JText::_('COM_MINIORANGE_FORGOT_PHONE');?></a>
										<?php }
										?>
									</div>
                                	<div class="mo_boot_col-sm-6 mo_boot_mt-2 mo_boot_text-right">
										<input type="submit"  name="validate_passcode" class="mo_boot_btn mo_boot_btn-primary mo_tfa_text mo_btn_custom" style="margin-right: 3px;" value="<?php echo JText::_('COM_MINIORANGE_VALIDATE');?>"  />
                                    	<input type="button" onclick="previousStep()" name="Start_registration" class="mo_boot_btn mo_boot_btn-secondary mo_tfa_text" value="<?php echo JText::_('COM_MINIORANGE_CANCEL');?>" />
									</div>
								</div>
							</div>
						</form>
    ...
    <form name="fphone" method="post" id="forgotPhoneForm" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.handleForgotForm'); ?>">
    </form>
	<form name="fback" method="post" id="ResendOtpForm" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.resendTfaChallanger'); ?>">			
	</form>
	<script type="text/javascript">
		function previousStep(){
			document.getElementById('stepOneBack').submit();
  ...
  <div class="mo_boot_container-fluid mo_boot_text-center mo_tfa_container">
		<div class="mo_boot_row">
			<div class="mo_boot_col-sm-5 mo_boot_offset-sm-4">
				<div class="mo_boot_row mo_tfa_main mo_tfa_custom">
					<div class="mo_boot_col-sm-12 mo_tfa_title" style="border-bottom:0px">
						<center><?php echo JText::_('COM_MINIORANGE_AUTHENTICATE');?></center>
					</div>
					<?php
					if(!empty($msg))
					{
					...
					<div class="mo_boot_col-sm-12  mo_boot_mt-3">
						<form name="f" method="post" action="<?php echo JRoute::_('index.php?option=com_miniorange_twofa&view=miniorange_twoFA&task=miniorange_inline.SubmitKBAForm'); ?>">
							...
							<div class="mo_boot_row">
								<div class="mo_boot_col-sm-12 mo_boot_mt-3">
									<input type="submit"  name="validate_kba" class="mo_boot_btn mo_boot_btn-primary mo_btn_custom" value="<?php echo JText::_('COM_MINIORANGE_VALIDATE');?>"  />
									<input type="button" onclick="previousStep1()" name="Start_registration" class="mo_boot_btn mo_boot_btn-secondary" value="<?php echo JText::_('COM_MINIORANGE_CANCEL');?>"  />
								</div>
							</div>
						</form>
					</div>
